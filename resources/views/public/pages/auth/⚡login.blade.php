...
<div>
    ...
    <div class="min-h-screen bg-[#0f0f0f] flex items-center justify-center p-4 sm:p-6 font-sans">
        ...
        <div
            class="max-w-5xl w-full bg-[#181818] rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] overflow-hidden flex flex-col md:flex-row border border-white/5">
            ...
            <div class="hidden md:flex md:w-5/12 relative bg-cover bg-center overflow-hidden"
                ...
                <div class="absolute bottom-12 left-10 right-10">
                    <h1 class="text-4xl font-light text-white leading-tight"><br><span class="font-bold text-white">3A
                            CareTering</span></h1>
            ...
            <div class="w-full md:w-7/12 p-8 sm:p-16 flex flex-col justify-center bg-[#181818]">
                ...
                <form wire:submit.prevent="login" class="space-y-10">
                    ...
                    <div class="group relative">
                        <label for="email"
                            class="text-[10px] uppercase tracking-[0.2em] text-neutral-500 group-focus-within:text-white transition-colors font-bold block mb-1">
                            Email Address
                        </label>
                    ...
                    <div class="group relative">
                        <div class="flex justify-between items-end mb-1">
                            <label for="password"
                                class="text-[10px] uppercase tracking-[0.2em] text-gray-500 group-focus-within:text-[#e1e1e1] transition-colors font-bold block">
                                Password
                            </label>
                            <a href="#"
                                class="text-[10px] text-gray-600 hover:text-[#84a31a] transition-colors uppercase tracking-widest">Forgot?</a>
                        </div>
                        <input type="password" wire:model.defer="password" name="password" required
                    ...
                    <div class="flex items-center space-x-3">
                        <label class="relative flex items-center cursor-pointer">
                            <input type="checkbox" wire:model.defer="remember" name="remember" class="peer sr-only">
                            <div
                                class="w-4 h-4 border border-white/20 rounded bg-transparent peer-checked:bg-[#84a31a] peer-checked:border-transparent transition-all">
                            </div>
                            <svg class="absolute w-3 h-3 text-white left-0.5 hidden peer-checked:block" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor" stroke-width="4">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7" />
                            </svg>
                            <span class="ml-3 text-xs text-gray-500 hover:text-gray-300 transition-colors">Remember this
                                device</span>
                        </label>
                    </div>
