                ...
                <form wire:submit.prevent='create'>
                    <div class="grid gap-4 lg:gap-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
                            <div>
                                <label for="menu_name"
                                    class="block mb-2 text-sm text-gray-700 font-medium dark:text-white">Menu Name</label>
                                <input wire:model.defer='menu_name' type="text" id="menu_name"
                            ...
                            <div>
                                <label for="type_of_menu"
                                    class="block mb-2 text-sm text-gray-700 font-medium dark:text-white">Type of Menu</label>
                                <select wire:model.defer='type_of_menu' id="type_of_menu"
                                    class="py-2.5 sm:py-3 px-4 block w-full border-gray-200 rounded-lg sm:text-sm 
                                           focus:border-blue-500 focus:ring-blue-500 
                        ...
                        <div>
                            ...
                            <textarea wire:model.defer='description' id="description" rows="3"
                                class="py-2.5 sm:py-3 px-4 block w-full border-gray-200 rounded-lg sm:text-sm 
                                       focus:border-blue-500 focus:ring-blue-500 
                                       dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500"></textarea>
                            @error('description')
                                <span class="mt-2 text-sm text-red-600 dark:text-red-500">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div>
                            <label for="image" class="block mb-2 text-sm text-gray-700 font-medium dark:text-white">Menu Image</label>
                        ...
                        <div>
                            ...
                            <input wire:model.defer='price' type="number" step="0.01" id="price"
                                class="py-2.5 sm:py-3 px-4 block w-full border-gray-200 rounded-lg sm:text-sm 
                                       focus:border-blue-500 focus:ring-blue-500 
                                       dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500">
                            @error('price')
